...
const TooltipArrow = React.forwardRef<SVGSVGElement, TooltipArrowProps>(
  function TooltipArrow(
    { withTransition = true, ...props }: TooltipArrowProps,
    ref,
  ) {
    ...
    return (
      <MotionTooltipArrow
        ref={arrowRef as unknown as React.Ref<SVGSVGElement>}
        context={context}
...
function TooltipOverlay() {
  ...
  // Avoid passing a potentially incompatible ref coming from contentProps
  const { ref: _contentRef, ...safeContentProps } =
    (rendered.data?.contentProps as HTMLMotionProps<'div'> | undefined) || {};
...
const TooltipTrigger = React.forwardRef<HTMLDivElement, TooltipTriggerProps>(
  ...
  // Avoid passing any incoming ref from props to prevent type conflicts
  const { ref: _incomingRef, ...safeTriggerProps } = props;
